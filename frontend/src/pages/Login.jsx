...
import { CheckCircle, Mail, Lock, ArrowRight, Github, Chrome } from "lucide-react";
        ...
        <div className="relative z-10 p-12 text-white max-w-lg">
          ...
          >
            ...
            <p className="text-slate-400 text-lg leading-relaxed">
              Experience seamless collaboration with our advanced editor. Real-time updates, secure environment, and powerful tools for modern teams.
            </p>
          </motion.div>
          ...
          >
            ...
            <p className="text-slate-200 mb-4 italic">"This platform revolutionized how our remote team works. The real-time features are simply unmatched."</p>
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 rounded-full bg-gradient-to-r from-pink-500 to-orange-500"></div>
              <div>
                <h4 className="font-semibold text-sm">Sarah Jenkins</h4>
                <p className="text-xs text-slate-400">Product Lead @ TechFlow</p>
              </div>
            </div>
          </motion.div>
        </div>
